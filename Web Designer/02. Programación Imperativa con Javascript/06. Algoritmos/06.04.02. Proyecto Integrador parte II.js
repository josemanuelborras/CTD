...
// Odernar tareas por nombre: buble sort
...
// Odernar tareas por fecha: buble sort
...
// Buscar tarea por nombre, retorna posicion:
function buscarPorNombre(nombre) {
  ...
  while(inicio <= fin) {
    ...
    if(tareas[posicionMedio].nombre === nombre) {
      return posicionMedio;
    } else if (tareas[posicionMedio].nombre < nombre) {
...
function mostrarMenu() {
  ...
  console.log("13. Buscar por nombre");
  console.log("0. Salir");
}
  ...
  while (opcion != 0) {
    ...
    switch (opcion) {
      ...
      case 13:
        ...
        if(indice !== -1) {
          console.log("Tarea encontrada: ", indice);
        } else {
